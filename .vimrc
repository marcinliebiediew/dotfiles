...
nnoremap <Leader>jj :call VSCodeNotify('workbench.action.terminal.toggleTerminal')<CR>
try
...
if exists('g:vscode')
  ...
  map <silent> <leader>rr :Ranger<CR>
  ...
  nnoremap <silent> <leader>id  :<C-u>CocList diagnostics<cr>
  " Manage extensions.
  ...
  call UseSpaces()
  au FileType dart,javascript,python,php,xml,yaml,json :RainbowLevelsOn
  map <leader>rb :RainbowLevelsToggle<cr>
