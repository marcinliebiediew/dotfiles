...
let g:which_key_map['n'] = [ ':ScratchInsert'             , 'notepad' ]
let g:which_key_map['t'] = [ ':FloatermToggle'            , 'terminal' ]
let g:which_key_map['p'] = [ ':CocList floterm'           , 'pick terminal' ]
...
let g:which_key_map.r = {
      \ 'name' : '+run' ,
      \ 'r' : [':RustRun'                                       , 'rust run'],
      \ 'R' : [':RustTest!'                                     , 'rust test all'],
      \ 'm' : [':MarkdownPrewiew'                               , 'markdown'],
      \ 'g' : [':!go run %<CR>'                                 , 'go run'],
      \ 'h' : [':Bracey'                                        , 'HTML CSS JS'],
      \ 'H' : [':BraceyReload'                                  , 'HTML CSS JS preview'],
      \ }

" t is for terminal
let g:which_key_map.T = {
      \ 'name' : '+terminal' ,
      \ ';' : [':FloatermNew --wintype=popup --height=6 --name=terminal'        , 'terminal'],
